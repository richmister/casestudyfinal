...
import perscholas.demo.database.dao.UserRoleDAO;
import perscholas.demo.database.entity.User;
import perscholas.demo.database.entity.UserRole;
import perscholas.demo.form.RegisterFormBean;
...
public class RegistrationController {
    ...
    public ModelAndView userList(@RequestParam(required = false) String search, @RequestParam(required = false) String firstName,
        ...
        if ( ! StringUtils.isEmpty(search)) {
            List<User> users = userRepository.findByFirstNameContainingIgnoreCaseOrLastNameContainingIgnoreCase(search,search);
...
System.out.println("we're registering");
        ...
        if (errors.hasErrors()) {
            ...
            if ( form.getId() == null ) {
                ...
                user = userRepository.findById(form.getId());
            }
