...
//import perscholas.demo.form.LoginFormBean;
...
//        System.out.println("usernameFromFrom using LoginFormBean = " + form.getEmailFromForm());
...
//        ModelAndView response = new ModelAndView();
//
//        String username = form.getEmailFromForm();
//        String password = form.getPasswordFromForm();
//
//        if (StringUtils.equals(username, "tom") && StringUtils.equals(password, "jerry")) {
//            session.setAttribute(SESSION_KEY, form.getEmailFromForm());
//            response.setViewName("redirect:/success");
