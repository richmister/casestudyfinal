...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-center row">
        <div class="col-md-8">
            ...
            <div class="d-flex flex-row align-items-center mt-3 p-2 bg-white rounded"><button class="btn btn-warning btn-block btn-lg ml-2 pay-button"
             type="button"  <a class="nav-link" href="/checkout" style=" color: white;font-size: x-large;"></a> >Checkout</button></div>
        </div>
    </div>
</div>
