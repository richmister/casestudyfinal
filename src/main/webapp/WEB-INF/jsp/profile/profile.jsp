                    ...
                    <div class="osahan-user text-center">
                        <div class="osahan-user-media">
                            ...
                            <div class="osahan-user-media-body">
                                ...
                                <p class="mb-0 text-black font-weight-bold"><a class="text-primary mr-3" data-toggle="modal" data-target="#edit-profile-modal" href="#"><i class="icofont-ui-edit"></i></a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="float-right">
                                            <a class="btn btn-sm btn-outline-primary" href="#"><i class="icofont-headphone-alt"></i></a>
                                            <a class="btn btn-sm btn-primary" href="#"><i class="icofont-refresh"></i> REORDER</a>
                                        </div>
                                        <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"></span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="float-right">
                                            <a class="btn btn-sm btn-outline-primary" href="#"><i class="icofont-headphone-alt"></i></a>
                                            <a class="btn btn-sm btn-primary" href="#"><i class="icofont-refresh"></i></a>
                                        </div>
                                        <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"> </span>
                                        </p>
                                    </div>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-gray mb-3"><i class="icofont-list"></i>  <i class="icofont-clock-time ml-2"></i> Mon, Nov 12, 6:26 PM</p>
